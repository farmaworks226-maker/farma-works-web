...
export default function InsanKaynaklariPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 1. ÜST BANNER (Mavi tonlu) */}
      <div className="relative h-[300px] w-full bg-[#0f172a] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl text-center">
        <h2 className="text-3xl font-bold text-[#1e293b] mb-6">İnsan Kaynakları</h2>
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="flex flex-col items-center text-center mb-16">
            <div className="w-16 h-16 bg-[#1e293b] rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300">
              <Users className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold text-[#1e293b] mb-4">Çalışanlarımızı Destekliyoruz</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-2xl font-bold text-[#1e293b] mb-4">İş Yerinde Değerlerimiz</h3>
            <p className="text-gray-600 leading-relaxed max-w-3xl">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl group">
               {/* DÜZELTME: onError kaldırıldı, Server Component kurallarına uyuldu */}
               <Image 
                 src="/images/foto.jpg" 
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-[#1e293b]">Bize Katılın</h2>
              <div className="w-20 h-1 bg-[#00b074] rounded-full"></div>
              ...
              <div className="pt-4">
                <Link 
                  href="/iletisim" 
                  className="inline-flex items-center bg-[#1e293b] text-white px-8 py-4 rounded-full font-bold hover:bg-[#00b074] transition-colors group"
                >
                  Başvuru Yap
