...
async function fetchContent() {
  ...
  const possibleSlugs = [
    "kurumsal/kvkk/imha-ve-saklama-politikasi",
    "kvkk/imha-ve-saklama-politikasi",
    "imha-ve-saklama-politikasi"
  ]
...
export default async function ImhaPolitikasiPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center text-gray-500 p-4 text-center">
        <div>
            ...
            <p>Storyblok&apos;ta &quot;imha-ve-saklama-politikasi&quot; slug&apos;ına sahip veya isminde &quot;imha&quot; geçen bir içerik oluşturduğunuzdan emin olun.</p>
        </div>
      </div>
    )
  }
