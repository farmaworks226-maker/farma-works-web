...
export function KisiselBakimContent({ products }: { products: any[] }) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-10 text-center">
        <div>
          ...
          <p className="text-gray-500 mt-2">Storyblok panelinden 'Kişisel Bakım' kategorisine içerik ekleyiniz.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        {/* --- ALT BİLGİ: KİŞİSEL BAKIMIN ÖNEMİ --- */}
