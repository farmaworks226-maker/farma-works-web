...
import { ArrowRight, X, Check, AlertCircle, Info, Thermometer, Tag, Sparkles, Sun, Droplets, Shield } from "lucide-react"
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-10 text-center">
        <div>
          ...
          <p className="text-gray-500 mt-2">
            Storyblok panelinden &apos;Kişisel Bakım&apos; kategorisine içerik ekleyiniz.
          </p>
        </div>
      </div>
    )
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Cildimiz, bizi dış etkenlerden koruyan en büyük organımızdır. Doğru
                içeriklerle yapılan düzenli bakım, cilt bariyerini güçlendirir ve yaşlanma
                belirtilerini geciktirir.
              </p>
            </div>
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 shrink-0"><Droplets className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Nem Dengesi</h4><p className="text-sm text-gray-500">Hyaluronik asit cildin su tutma kapasitesini artırır.</p></div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 shrink-0"><Sun className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Güneş Koruması</h4><p className="text-sm text-gray-500">SPF koruması, erken yaşlanmayı önler.</p></div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center text-purple-600 shrink-0"><Sparkles className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Hücresel Yenilenme</h4><p className="text-sm text-gray-500">Retinol ve Peptidler onarımı destekler.</p></div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div><h4 className="font-bold text-gray-900 mb-1">Bariyer Güçlendirme</h4><p className="text-sm text-gray-500">Seramidler hassasiyeti azaltır.</p></div>
              </div>
            </div>
          </div>
        </div>
