...
import { ArrowRight, X, Check, AlertCircle, Info, Thermometer, Tag, Sparkles, Heart, Activity, Shield } from "lucide-react"
import { render as renderRichText } from "storyblok-rich-text-react-renderer"

export function OzelTakviyeContent({ products }: { products: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        {/* --- ALT BİLGİ: ÖZEL TAKVİYELER FAYDALARI --- */}
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-pink-50 rounded-xl flex items-center justify-center text-pink-600 shrink-0"><Sparkles className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Cilt ve Gençlik</h4><p className="text-sm text-gray-500">Kolajen ve Glutatyon cildin elastikiyetini korur.</p></div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center text-red-600 shrink-0"><Heart className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Kalp ve Damar</h4><p className="text-sm text-gray-500">Omega-3 ve CoQ10 kalp sağlığını destekler.</p></div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 shrink-0"><Activity className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Eklem Sağlığı</h4><p className="text-sm text-gray-500">Glukozamin hareket kabiliyetini artırır.</p></div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center text-[#00b074] shrink-0"><Shield className="w-6 h-6" /></div>
                <div><h4 className="font-bold text-gray-900 mb-1">Antioksidan Koruma</h4><p className="text-sm text-gray-500">Vücuttaki toksinleri atmaya yardımcı olur.</p></div>
              </div>
            </div>
          </div>
        </div>
