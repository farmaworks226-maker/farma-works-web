                    ...
                    <div className="p-4 grid grid-cols-2 gap-6">
                      ...
                      <div className="border-l border-gray-200 pl-6" style={{ minWidth: '220px' }}>
                        ...
                        <ul className="space-y-1">
                          ...
                          <ListItem href="/kisisel-verileriniz#saklama" title="Saklama ve İmha Politikası">Veri saklama.</ListItem>
                ...
                <li>
                  <details className="group">
                    ...
                    <ul className="ml-4 mt-2 space-y-2">
                      ...
                      <li><Link href="/kisisel-verileriniz#aydinlatma" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-4 text-sm hover:bg-[#F3EBE2] rounded-md">Aydınlatma Metni</Link></li>
                      <li><Link href="/kisisel-verileriniz#saklama" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-4 text-sm hover:bg-[#F3EBE2] rounded-md">Saklama ve İmha Politikası</Link></li>
                      <li><Link href="/kisisel-verileriniz#basvuru" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-4 text-sm hover:bg-[#F3EBE2] rounded-md">Başvuru Formu</Link></li>
                    </ul>
                  </details>
                </li>
                <li>
