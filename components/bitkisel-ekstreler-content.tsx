...
import { ArrowRight, X, Check, AlertCircle, Info, Thermometer, Tag, Leaf, TreePine, Flower2, Sparkles, Shield, Moon } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {(!products || products.length === 0) ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 mt-2">Storyblok panelinden &apos;Bitkisel Ekstreler&apos; kategorisine içerik ekleyiniz.</p>
          </div>
        ) : (
