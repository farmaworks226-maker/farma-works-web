...
export function MultivitaminContent({ products }: { products: any[] }) {
  ...
  // Metin veya RichText Dolu mu?
  const hasData = (content: any) => {
    if (!content) return false;
    // Düz yazı ise ve boşluklardan ibaret değilse
    if (typeof content === 'string') return content.trim().length > 0;
    // RichText objesi ise
    if (typeof content === 'object') {
        if (content.content && Array.isArray(content.content) && content.content.length > 0) {
             // İçinde boş bir paragraf varsa bile dolu sayılabilir ama genellikle yeterlidir
             return true;
        }
    }
    return false;
  ...
  const hasTableData = (table: any) => {
    ...
    // Satırların içinde en az bir dolu hücre var mı?
            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  {/* KISA AÇIKLAMA: Sadece doluysa göster (Opsiyonel) */}
          ...
          <div className="bg-white w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl relative animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 md:p-10">
              ...
              <div className="mt-12 space-y-6">
                ...
                {/* İçerik ve Kullanım (Sadece doluysa) */}
                ...
                {/* Saklama Koşulları (Sadece doluysa) */}
