      ...
      <div className="bg-orange-50 py-20 text-center border-b border-orange-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-orange-800/80 max-w-3xl mx-auto">
            Bağışıklığınızı ve enerjinizi destekleyen C, D, B12 ve diğer temel vitamin takviyeleri.
          </p>
        </div>
      </div>
        ...
        {(!products || products.length === 0) ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 mt-2">
              Storyblok panelinden &apos;Vitaminler&apos; kategorisine içerik ekleyiniz.
            </p>
          </div>
        ) : (
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-orange-800/70 max-w-2xl mx-auto">
              Vücudumuzun sağlıklı işleyişi için elzem olan vitaminler, bağışıklık sisteminden enerji üretimine kadar birçok fonksiyonda anahtar rol oynar.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                C vitamini ve D vitamini gibi antioksidanlar, bağışıklık sistemini güçlendirerek hastalıklara karşı koruma sağlar.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                B grubu vitaminleri, yediğimiz besinlerin enerjiye dönüşmesinde hayati rol oynar. Gün boyu zinde kalmanızı destekler.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                E vitamini ve A vitamini, hücrelerin yenilenmesine ve cildin sağlıklı kalmasına yardımcı olan güçlü antioksidanlardır.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Belli başlı vitaminler kalp damar sağlığını korurken, A vitamini gibi besinler görme yetisinin korunmasına katkıda bulunur.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                B12 vitamini ve folik asit, beyin fonksiyonlarının, hafızanın ve konsantrasyonun korunması için kritik öneme sahiptir.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-orange-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                D vitamini, kalsiyum emilimini artırarak kemiklerin ve dişlerin güçlü kalmasını sağlar.
              </p>
            </div>
          </div>
        </div>
