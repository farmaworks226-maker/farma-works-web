...
export function MinerallerContent({ products }: { products: StoryblokStory<Product>[] }) {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-10 text-center">
        <div>
          ...
          <p className="text-gray-500 mt-2">
            Storyblok panelinden &apos;Mineraller&apos; kategorisine içerik ekleyiniz.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ÜST BAŞLIK */}
      <div className="bg-cyan-50 py-20 text-center border-b border-cyan-100">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-cyan-900 mb-4">Mineraller</h1>
          <p className="text-lg text-cyan-800/80 max-w-3xl mx-auto">
            Kemik, kas ve sinir sağlığı için gerekli kalsiyum, magnezyum, çinko ve diğer mineral takviyeleri.
          </p>
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-80 bg-gray-100 overflow-hidden">
                  <span className="absolute top-4 left-4 bg-white/90 text-cyan-600 text-[10px] font-bold px-2 py-1 rounded border border-cyan-100 uppercase tracking-wide z-10">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-50">
                    <span className="text-cyan-600 text-sm font-bold flex items-center group-hover:translate-x-1 transition-transform">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-cyan-800/70 max-w-2xl mx-auto">
                Mineraller vücudumuzun düzgün çalışması için vazgeçilmez besin öğeleridir.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-cyan-100 hover:shadow-md transition duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Kalsiyum ve magnezyum güçlü kemikler ve dişler için temel yapı taşlarıdır.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-cyan-100 hover:shadow-md transition duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Demir, kırmızı kan hücrelerinin oluşumu ve oksijen taşınması için kritiktir.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-cyan-100 hover:shadow-md transition duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Potasyum ve magnezyum kalp ritminin düzenlenmesinde önemli rol oynar.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-cyan-100 hover:shadow-md transition duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Çinko ve selenyum enerji üretiminde ve metabolizmada görev alır.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-cyan-100 hover:shadow-md transition duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Çinko ve selenyum bağışıklık sisteminin güçlenmesine yardımcı olur.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-cyan-100 hover:shadow-md transition duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Magnezyum sinir iletimini destekler ve kas gevşemesine yardımcı olur.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="grid lg:grid-cols-12 gap-10">
                  ...
                  <div className="lg:col-span-7 space-y-8">
                    ...
                    {hasData(selectedProduct.net_quantity) && (
                      <div className="inline-flex items-center gap-2 bg-cyan-50 text-cyan-600 px-5 py-2.5 rounded-lg font-bold border border-cyan-100 shadow-sm">
                ...
                <div className="mt-12 space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    {hasData(selectedProduct.ingredients) && (
                      <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="flex items-center gap-2 font-bold text-gray-900 mb-3 text-lg">
                          <Info className="w-6 h-6 text-cyan-500" /> İçerik
                        </div>
                    ...
                    {hasData(selectedProduct.usage) && (
                      <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="flex items-center gap-2 font-bold text-gray-900 mb-3 text-lg">
                          <AlertCircle className="w-6 h-6 text-cyan-500" /> Kullanım Şekli
                        </div>
                        <div className="text-gray-700 leading-relaxed text-sm">
                  ...
                  {hasData(selectedProduct.price) && (
                    <div className="bg-cyan-50 border border-cyan-200 p-6 rounded-xl flex items-center justify-between shadow-sm">
                      <div className="flex items-center gap-4">
                        <div className="bg-white p-3 rounded-full shadow-md text-cyan-500">
                          <Tag className="w-6 h-6" />
                        </div>
                        <div className="font-bold text-cyan-900 text-lg">Satış Fiyatı:</div>
                      </div>
                      <div className="text-2xl font-extrabold text-cyan-600">{selectedProduct.price}</div>
                    </div>
                  )}
                </div>
