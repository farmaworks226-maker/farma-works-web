    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#F3EBE2] py-20 text-center border-b border-[#e5d9ca]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl font-bold text-[#1E40D8] mb-4">Mineraller</h1>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">Kemik, kas ve sinir sağlığı için gerekli kalsiyum, magnezyum, çinko ve diğer mineral takviyeleri.</p>
        </div>
      </div>
            ...
            return (
              <div key={item.uuid} onClick={() => handleSelectProduct(product)} className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col cursor-pointer h-full">
                <div className="relative h-80 bg-gray-100 overflow-hidden">
                  <span className="absolute top-4 left-4 bg-white/90 text-[#1E40D8] text-[10px] font-bold px-2 py-1 rounded border border-blue-100 uppercase tracking-wide z-10">{product.category || "Mineraller"}</span>
      ...
      {/* MİNERALLER FAYDALARI - BEJ TEMA */}
      <div className="bg-[#F3EBE2] py-24">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-[#1E40D8] mb-4">Mineraller Neden Önemlidir?</h2>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">Mineraller vücudumuzun düzgün çalışması için vazgeçilmez besin öğeleridir.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#e5d9ca] hover:shadow-md transition duration-300">
              <div className="w-14 h-14 bg-[#F3EBE2] rounded-full flex items-center justify-center mb-6 text-[#ED6E2D]"><Bone className="w-8 h-8" /></div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Kemik Sağlığı</h3>
              <p className="text-gray-600 leading-relaxed">Kalsiyum ve magnezyum güçlü kemikler ve dişler için temel yapı taşlarıdır.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#e5d9ca] hover:shadow-md transition duration-300">
              <div className="w-14 h-14 bg-[#1E40D8]/10 rounded-full flex items-center justify-center mb-6 text-[#1E40D8]"><Droplet className="w-8 h-8" /></div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Kan Yapımı</h3>
              <p className="text-gray-600 leading-relaxed">Demir, kırmızı kan hücrelerinin oluşumu ve oksijen taşınması için kritiktir.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#e5d9ca] hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Potasyum ve magnezyum kalp ritminin düzenlenmesinde önemli rol oynar.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#e5d9ca] hover:shadow-md transition duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Enerji Metabolizması</h3>
              <p className="text-gray-600 leading-relaxed">Çinko ve selenyum enerji üretiminde ve metabolizmada görev alır.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#e5d9ca] hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Çinko ve selenyum bağışıklık sisteminin güçlenmesine yardımcı olur.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#e5d9ca] hover:shadow-md transition duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Sinir Sistemi</h3>
              <p className="text-gray-600 leading-relaxed">Magnezyum sinir iletimini destekler ve kas gevşemesine yardımcı olur.</p>
            </div>
          </div>
        </div>
      </div>
